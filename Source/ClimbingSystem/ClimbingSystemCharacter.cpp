...
void AClimbingSystemCharacter::Move(const FInputActionValue& Value)
{
	...
	{
		HandleClimbingMovementInput(MovementVector);
	}
	else
	{
		HandleGroundMovementInput(MovementVector);
	}
}

void AClimbingSystemCharacter::HandleGroundMovementInput(const FVector2D& MovementVector)
{
...
void AClimbingSystemCharacter::HandleClimbingMovementInput(const FVector2D& MovementVector)
{
	if (Controller != nullptr)
	{
		const FVector ForwardDirection = CustomMovementComponent->GetForwardClimbingDirection();
		const FVector RightDirection = CustomMovementComponent->GetRightwardClimbingDirection();
...
void AClimbingSystemCharacter::OnClimbActionStarted(const FInputActionValue& Value)
{
	...
	CustomMovementComponent->ToggleClimbing();
}
